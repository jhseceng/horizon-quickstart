...
:partner-product-name: CrowdStrike Falcon Horizon AWS Control Tower Integration
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: CrowdStrike Falcon Horizon
// If there's no partner, comment partner-company-name.
:partner-company-name: CrowdStrike
:doc-month: October
:doc-year: 2022
...
:partner-contributors: Justin Harris, CrowdStrike
:aws-contributors: AWS Enterprise Support
